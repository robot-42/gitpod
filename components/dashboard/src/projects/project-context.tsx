...
export function useProjectSlug(): { projectSlug?: string; prebuildId?: string } {
...
export function useCurrentProject(): Project | undefined {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const project = slugs.projectSlug && projects.find((p) => Project.slug(p) === slugs.projectSlug);
            if (!project) {
                return;
            }
            setProject(project);
